...
$website_title=$article->title . " | PHP BLOG";
	...
	<div class="row">
		<div class="col-md-8 mb-3">
			...
			<form action="news.php?id=<?=$_GET['id']?>" method="post">
				...
				<button type="submit" class="btn btn-success mt-3 mb-5" id="mess_send" name="mess_send">Добавить комментарий</button>
			</form>
			<?php
			if (isset($_POST['username']) && isset($_POST['mess']) && $_POST['username']!='' && $_POST['mess']!='') {
